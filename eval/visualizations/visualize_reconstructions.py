...
from models.baselines.autoencoder import ConvAutoencoder

def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', type=str, default='data/transitions/test_transitions.npz')
    parser.add_argument('--checkpoint', type=str, default='checkpoints/baselines/autoencoder_latent64.pt')
    parser.add_argument('--latent_dim', type=int, default=64)
    parser.add_argument('--out_path', default='outputs/reconstructions.png')
