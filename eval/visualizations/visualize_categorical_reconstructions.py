...
from models.baselines.categorical_autoencoder import CategoricalAutoencoder
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoints/baselines/categorical_autoencoder_latent64.pt')
