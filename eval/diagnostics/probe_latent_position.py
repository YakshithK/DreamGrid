...
def main():
    ...
    parser.add_argument('--train_path', type=str, default='data/transitions/train_transitions.npz')
    parser.add_argument('--test_path', type=str, default='data/transitions/test_transitions.npz')
    parser.add_argument('--latent_dim', type=int, default=128)
    parser.add_argument('--checkpoint', type=str, default='checkpoints/baselines/tile_autoencoder_latent128.pt')
