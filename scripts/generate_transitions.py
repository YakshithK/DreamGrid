...
def main():
    ...
    current_image = obs_tensor[0].detach().cpu()
    ...
    for rank in range(top_k):
        ...
        axes[rank, 0].imshow(image_for_plot(current_image))
    ...
    axes[actual_row, 0].imshow(image_for_plot(current_image))
    ...
    out_path = os.path.join(
        args.out_dir,
        f"vq_imagination_seed{args.seed}_h{args.horizon}_c{args.candidates}.png",
    )
